import {
  ...
  import { isReturnLocation } from "../validations/returnLocationResponseValidation";
  import FormErrorResponse from "../entities/FormErrorResponse";
  import ReturnLocation from "../entities/returnLocationEntity";
  function EditReturnLocationPage() {
    const data = useLoaderData();
    const dataIsLocation = isReturnLocation(data);
  ...
  export const loader: LoaderFunction = async (loaderArgs) => {
    ...
    const url = `http://localhost:8080/returnlocations/${id}`;
  ...
  export const action: ActionFunction = async (actionArgs) => {
    ...
    const url = `http://localhost:8080/returnlocations?id=${id}`;
  ...
  export default EditReturnLocationPage;